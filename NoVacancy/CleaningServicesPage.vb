...
Public Class CleaningServicesPage
...
#Region "onLoad region"
    Private Sub CleaningServicesPage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CB_State.Items.Add("Completada")
        CB_State.Items.Add("En espera")
        CB_State.Items.Add("En progreso")
        ShowCleaningIncidents()
    End Sub
#End Region
    ...
    Private Sub DataGridView1_SelectionChanged(sender As Object, e As EventArgs) Handles DataGridView1.SelectionChanged
        Try
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                incidentId = Convert.ToInt32(selectedRow.Cells("id_limpieza").Value)
...
#Region "Main subs and functions region"
    ...
    Private Sub ShowCleaningIncidents()
        Dim query As String = "SELECT 
                                ...
                                l.id_limpieza
                               FROM limpieza l
                               LEFT JOIN Habitacion h ON h.id_habitacion = l.id_habitacion"
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            If dataTable.Rows.Count > 0 Then
                ...
                DataGridView1.Columns("id_limpieza").Visible = False
                'FillTextBox()
            Else
    ...
    Private Sub UpdateCleaningRegistry()
        ...
        If result = DialogResult.OK Then
            ...
            Dim query As String = " UPDATE Limpieza
                                    SET fecha = @cleaningDate, descripcion = @description, estado = @incidentState
                                    WHERE id_limpieza = @id_limpieza
                                    "
            Using connection As New MySqlConnection(connectionString)
                Using command As New MySqlCommand(query, connection)
                    command.Parameters.AddWithValue("@cleaningDate", cleaningDate.ToString("yyyy-MM-dd"))
                    command.Parameters.AddWithValue("@description", description)
                    command.Parameters.AddWithValue("@incidentState", incidentState)
                    command.Parameters.AddWithValue("@id_limpieza", incidentId)
