...
#Region "Button events region"
    ...
    'Llama a la función UpdateProducts
...
#Region "Other controls events region"
    ...
    'Pinta las filas del grid según el stockaje
    ...
    'Rellena los txtbox necesarios cuando un producto es seleccionado
...
#Region "Main subs and functions region"
    ...
    'Rellena el grid con los productos y sus cantidades
    ...
    'Rellena el listbox con los productos que están por debajo de su stock minimo
    ...
    'Actualiza un producto con los datos introducidos
